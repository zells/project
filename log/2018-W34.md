...
Started sketching the "Sending Message" use case where I want to show how actual structured messages with receiver and sender are used to communicate with Zells. Lots of tricky decisions. Too many to elaborate here. Maybe I even skip the use case and go directly to "3 + 4" to show some actually useful behavior. But a lot of fun to think this through. Spent about 2 hours in my hammock in the park doin it.
